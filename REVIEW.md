...
Project-specific focus: Bounded cryptography and admissibility claims, Python/TypeScript contract parity, defensive-only security behavior, and explicit dry-run versus live execution semantics.
